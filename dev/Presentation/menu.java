...
public class menu {
    ...
    public void generateDefectivesReport() throws SQLException {
    ...
    public void removeItem() throws SQLException, InterruptedException {
    ...
    public JsonObject removeItem(int itemID) throws SQLException, InterruptedException {
        JsonObject result = system.removeItem(itemID);
        return result;
    }


    public void markAsDefective() throws Exception {
        System.out.println("Enter item ID: ");
        int itemID = scan.nextInt();
        scan.nextLine();
    ...
    public void discountByCategory() throws SQLException {
    ...
    public void discountByProduct() throws SQLException {
        JsonObject json = new JsonObject();
    ...
    public JsonObject getItemDetails() { //get all product details from user
        JsonObject json = new JsonObject();
