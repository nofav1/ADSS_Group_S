...
public class MainLoginScreen {
    private Scanner mScan = new Scanner(System.in);
        ...
        while (choose != 7) {
            ...
            switch (choose) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    // Only if the worker is warehouse role
                    if (workerController.getCurrWorker().getRole().getName().equals("warehouse")){
                        menu menu = new menu();
                        menu.showMenu(); // Shows the menu
                        mScan = new Scanner(System.in);
                    }else System.out.println("ERROR: Only warehouse workers can get in to Management Inventory Screen.");
                    break;
                case 7:
